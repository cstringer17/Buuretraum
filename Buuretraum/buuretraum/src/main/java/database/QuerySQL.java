...
public class QuerySQL {
	...
	public static String queryDB(String q) {
		...
		try {
			...
			String url = "jdbc:mysql://localhost:3306/buuretraum?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone="
	...
	public static boolean login(String usernameField, String passwordField) {
